...
if __name__ == "__main__":
    ...
    model_path='/content/Traffic_Analysis_Using_Computer_Vision/number_plate.pt'
    model=YOLO(model_path)
  
    video_path='/content/Traffic_Analysis_Using_Computer_Vision/Result/demo.mp4'
    output_path='/content/Traffic_Analysis_Using_Computer_Vision/Result/'

    # Enable streaming and open the video file
